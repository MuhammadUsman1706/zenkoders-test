...
const Auth: FC = () => {
  ...
  return (
    <section className="max-w-[100%] p-[5%]">
      ...
      <div className="my-8">
        <div className="g-2 flex h-full flex-wrap items-center justify-center items-center lg:justify-between mx-auto gap-y-20">
          ...
          <div className="mb-12 md:mb-0 max-[640px]:w-full sm:w-10/12 md:w-8/12 lg:w-6/12 xl:w-6/12">
            <form onSubmit={authenticationHandler}>
              ...
              <div className="text-center lg:text-left">
                <button
                  type="submit"
                  className="flex max-[426px]:mx-auto justify-center gap-x-2 items-center text-black inline-block rounded bg-primary px-7 pb-2.5 pt-3 text-sm font-medium uppercase leading-normal shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)]"
                  data-te-ripple-init
